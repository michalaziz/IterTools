...
int main()
{
    ...
    if (signal == 0)
    {
        ...
        testcase.CHECK_EQUAL(iterable_to_string(chain(chain(range(0, 4), range(1, 5)), chain(range(2, 4), range(3, 3)))), string("0,1,2,3,1,2,3,4,2,3,"));

        testcase.CHECK_EQUAL(iterable_to_string(chain(chain(range('5', ':'), range('H', 'K')), string("%^&"))), string("5,6,7,8,9,H,I,J,%,^,&,"));
        ...
        testcase.CHECK_EQUAL(iterable_to_string(zip(zip(range(1, 6), string("hello")), zip(range(1, 6), string("hello")))), string("1,h,1,h,2,e,2,e,3,l,3,l,4,l,4,l,5,o,5,o,"));
